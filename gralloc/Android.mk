...
GRALLOC_DISP_W?=0
GRALLOC_DISP_H?=0
# Maximum buffer dimensions in pixels when buffer will use AFBC
GRALLOC_MAX_DISP_W?=0
GRALLOC_MAX_DISP_H?=0
...
LOCAL_CFLAGS += -DGRALLOC_MAX_DISP_W=$(GRALLOC_MAX_DISP_W)
LOCAL_CFLAGS += -DGRALLOC_MAX_DISP_H=$(GRALLOC_MAX_DISP_H)
