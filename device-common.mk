...
ifeq ($(PRODUCT_DISPLAY_DENSITY),)
TARGET_DISPLAY_DENSITY := 320
else
TARGET_DISPLAY_DENSITY := $(PRODUCT_DISPLAY_DENSITY)
endif
PRODUCT_PROPERTY_OVERRIDES += ro.sf.lcd_density=$(TARGET_DISPLAY_DENSITY)
