...
#define ALL_PROC_ID_MASK	(HMD_ID_MASK | DMX_ID_MASK)

/* Tunnel Event System ID*/
#define IAXXX_MODULE_INSTANCE_ID_TUNNEL_MANAGER  (0)

#define IAXXX_MODULE_TYPE_TUNNEL_MANAGER  (6)
#define IAXXX_PROC_ID_TUNNEL_MANAGER  (IAXXX_DMX_ID)

/* Tunnel event sysid for ia8x01 : 0x2a60, else 0x2670 */
...
#define IAXXX_PROC_ID_SENSOR_MANAGER	(IAXXX_DMX_ID)
...
#define IAXXX_PROC_ID_SCRIPT_MANAGER	(IAXXX_DMX_ID)
...
/*
 * Proc id: HMD-4, DMX-5
 * Block id: DMX-0, HMD-1
 */
#define IAXXX_PROC_ID_TO_BLOCK_ID(proc_id) \
	((proc_id == IAXXX_DMX_ID) ? 0 : 1)
#define IAXXX_BLOCK_ID_TO_PROC_ID(block_id) \
	(block_id ? IAXXX_HMD_ID : IAXXX_DMX_ID)
