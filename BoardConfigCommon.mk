...
# $(OUT_DIR)/target/product/$(TARGET_DEVICE) is equivalent to $(PRODUCT_OUT),
# but $(PRODUCT_OUT) hasn't been defined yet.
BOARD_PREBUILT_DTBOIMAGE := $(OUT_DIR)/target/product/$(TARGET_DEVICE)/$(DTBO_UNSIGNED)
