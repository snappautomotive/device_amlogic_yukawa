...
int main() {
    LOG(ERROR) << "TESTEST MAIN";

    ABinderProcess_setThreadPoolMaxThreadCount(0);

    std::shared_ptr<Lights> light = SharedRefBase::make<Lights>();

    // FIXME: need to mark as vendor compilation unit...

    // FIXME: service name should be computed libbinder functions?
    // FIXME: type should be included automatically?
